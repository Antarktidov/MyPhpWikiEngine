...
if (isset($_GET["article_id"])) {
    ...
    $sql = "SELECT * FROM articles WHERE id='$article_id' AND is_deleted='1'";
...
<body>
    <h1><?=$title;?></h1>
    <div style="display: flex; gap: 10px;"><a href="trashed-history.php?article_id=<?="$article_id";?>">История</a><a href="restore-article.php?article_id=<?="$article_id";?>">Восстановить</a></div>
    <p><?=$text;?></p>
</body>
</html>